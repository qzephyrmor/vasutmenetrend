...
<div  class="widget">
   ...
   <div class="inner">
        <form method="post" action="index.php">
            <ul id="login">
                <li> Username:<input type="text" name="username" value="" maxlength="20"><br></li>
                <li>  Password:<input type="password" name="password" value="" maxlength="20"><br></li>
                <li>  <input type="submit" name="send" value="Bejelentkezés"/></li>
            </ul>
        </form>
    </div>
